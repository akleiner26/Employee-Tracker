...
const viewAllEmployees = () => {
    let displayEmployees = connection.query("SELECT * FROM employee INNER JOIN department ON employee.department_id = department.id INNER JOIN role ON employee.role_id = role.id");
